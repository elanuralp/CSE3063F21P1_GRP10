...
public class SemesterStatistic {
    ...
    public void calculateSemesterStatistics(){
        ...
        for(i=0;i<deniedCourseSectionRegisterList.size();i++){
            ...
            String courseNameAndStatus = deniedCourseSectionRegisterList.get(i).courseSection.getCourse().getName()+ " DUE TO " + deniedCourseSectionRegisterList.get(i).status;
            String courseType =deniedCourseSectionRegisterList.get(i).courseSection.getCourse().getType();
    ...
    public void writeToJson(){
        ...
        for (Map.Entry<String,Integer> entry : courseMap.entrySet()){
            ...
            System.out.println(entry.getValue() + " STUDENTS COULDN'T REGISTER FOR "+ entry.getKey() + " PROBLEMS.");
        }
        ...
        for (Map.Entry<String,Integer> entry2 : courseTypeMap.entrySet()){
            ...
            System.out.println(entry2.getValue() + " STUDENTS COULDN'T REGISTER FOR A "+ entry2.getKey() + " THIS SEMESTER.");
        }
